...
namespace iplikciNedim\rıfkı;

use Upload;
use PDO;
use PDOException;

class rıfkı extends Upload{
    ...
    /**Database bağantısı için gerekli ayarlar */
    public static function rıfkıAyarlar($hostname,$database_name,$character_charset,$database_username,$database_password){
        self::$host = $hostname;
